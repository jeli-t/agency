            ...
            <div className={classes.hero_section}>
                ...
                <div className={classes.description}>
                    ...
                    <Text className={classes.text}>
                        You may ask what is the best digital marketing strategy, and there is no one right answer. Selection of the channels depends on the business's goals, target audience, budget, and the nature of products or services being promoted. See how we build successful strategies step by step.
                    </Text>
                </div>
            </div>
        </div>
